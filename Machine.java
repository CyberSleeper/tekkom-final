...
class Machine {
    ...
    public static void main(String[] args) {
        System.out.println("DEBUG: HMachine.PUSHMT = " + HMachine.PUSHMT);
    ...
    static void execute() {
        ...
        while (forever) {
            if (HMachine.pc > 470) {
                System.out.println("PC: " + HMachine.pc + " Op: " + HMachine.memory[HMachine.pc]);
            }
            switch (HMachine.memory[HMachine.pc]) {
                ...
                case HMachine.READI:
                    try {
                        HMachine.memory[HMachine.mt] = Integer.parseInt(new BufferedReader(
                ...
                default:
                    System.out.println("\nExecution error at location " + HMachine.pc +
                            " : illegal operation code: " + HMachine.memory[HMachine.pc]);
                    System.exit(1);
            }
        }
    }
